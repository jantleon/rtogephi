#Script para descargar tweets, limpiarlos de cara al análisis y adaptarlos para la visualización del a estructura de la red en Gephi.

##1. Conseguir tweets.
###Instalación del paquete rtweet.
...
BD <- search_tweets(
  "#hashtag o palabra que quieres buscar", n = 500000, retryonratelimit = TRUE, type = "recent", include_rts = TRUE, lang = "es"
)
